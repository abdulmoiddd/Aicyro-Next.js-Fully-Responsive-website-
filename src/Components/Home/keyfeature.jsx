...
const KeyFeature = () => {
  ...
  const sectionVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        ease: "easeOut",
        when: "beforeChildren",
        staggerChildren: 0.15, // Stagger animation for the main columns
      },
    },
  };

  const columnVariants = {
    hidden: { opacity: 0, x: -50 }, // Slide from left for left column
    visible: {
      opacity: 1,
      x: 0,
      transition: {
    ...
    hiddenRight: { opacity: 0, x: 50 }, // Slide from right for right column
    visibleRight: {
      opacity: 1,
      x: 0,
      transition: {
  ...
  // 4. RENDER THE COMPONENT WITH DYNAMIC DATA AND ANIMATIONS
  return (
    <motion.section
      className="bg-[#0B0219] text-white py-20 sm:py-24 px-4 sm:px-6 lg:px-8 flex items-center justify-center"
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
        ...
        <motion.div
          className="border border-gray-800 rounded-xl p-6 sm:p-8 md:p-12 shadow-lg relative"
          variants={columnVariants} // Apply column variants
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-3xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-6 lg:mb-8"
          >
            {introHeading}
          </motion.h1>
          ...
          <motion.p
            variants={itemVariants}
            className="text-sm sm:text-base text-gray-400 font-light leading-relaxed mb-8 sm:mb-10"
        ...
        >
          ...
          <motion.h2
            variants={itemVariants}
            className="text-3xl sm:text-4xl font-semibold leading-tight mb-4 sm:mb-6"
            dangerouslySetInnerHTML={{ __html: whyUsHeading }}
          />

          <motion.p
            variants={itemVariants}
            className="text-sm sm:text-base text-gray-400 font-light leading-relaxed mb-10 sm:mb-12"
          ...
          <div className="space-y-8">
            {principlesList.map((principle, index) => (
              <motion.div
                ...
                variants={featureItemVariants} // Use a specific variant for list items
              >
